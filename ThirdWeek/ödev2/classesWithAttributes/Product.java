...
public class Product {
    ...
    public Product(int id, String name, String description, double price, int stockAmount, String renk){ // product'ın  Constructor'ı bulundugu class ile aynı isimde olmalı
    ...
    public void setId(int id) { // id yazma izni verildi
        this.id = id; // this.id product clasındaki id nin oldugunu belirtmek için (içinde bulundugun class demek)
    }
